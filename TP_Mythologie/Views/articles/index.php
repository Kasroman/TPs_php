        ...
        <article class="card m-5">
            <a href="<?= ROOT_PUBLIC . 'articles/read/' . $article->id_article ?>">
                ...
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle text-muted mb-1">par <span class="fw-bold"><?= ucFirst($article->pseudo_user) ?></span> le <span class="fw-bold fst-italic"><?= $article->date_article ?></span></h6>
